...
class ChatViewModel: ObservableObject {
    ...
    private func processImage(_ image: UIImage) async {
        ...
        addUserMessage(
            content: currentPrompt ?? "Enhance this image",
            image: image
        )
        ...
        do {
            ...
            // Enhance prompt before sending to AI
            let enhancedPrompt = promptEnhancer.enhancePrompt(currentPrompt ?? "Enhance this image")
