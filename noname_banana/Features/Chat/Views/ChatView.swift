...
struct ChatView: View {
    ...
    @StateObject private var promptEnhancer = PromptEnhancer()
...
struct ChatContainerView: View {
    ...
    @ObservedObject var promptEnhancer: PromptEnhancer
    @EnvironmentObject var themeManager: ThemeManager
            ...
            ZStack {
                ...
                VStack(spacing: 0) {
                    ...
                    UnifiedHeaderBar(
                        ...
                        rightContent: AuthService.shared.isAuthenticated 
                            ? .empty 
    ...
    private func handleUploadTap() {
        if viewModel.remainingQuota <= 0 && !AuthService.shared.isAuthenticated {
    ...
    private func handleSendMessage() {
        ...
        if let prompt = viewModel.currentPrompt {
            let enhancedPrompt = promptEnhancer.enhancePrompt(prompt)
            viewModel.currentPrompt = enhancedPrompt
        }
        ...
        HStack(alignment: .bottom, spacing: DesignTokens.Spacing.sm) {
            ...
            Button(action: onImageTap) {
                Image(systemName: hasImageSelected ? "photo.fill" : "photo")
                    ...
                    .foregroundColor(hasImageSelected ? DesignTokens.Brand.primary : DesignTokens.Text.tertiary(themeManager.resolvedColorScheme))
            ...
            Button(action: onSendTap) {
                Image(systemName: "arrow.up.circle.fill")
                    ...
                    .foregroundColor(canSend ? DesignTokens.Brand.primary : DesignTokens.Text.quaternary(themeManager.resolvedColorScheme))
            }
            .buttonStyle(PlainButtonStyle())
    ...
    var body: some View {
        HStack(spacing: DesignTokens.Spacing.sm) {
            ...
            Button(action: {
                ...
                .background(
                    Capsule()
                        .fill(isSaving ? DesignTokens.Brand.secondary : DesignTokens.Brand.primary)
                )
            }
            .buttonStyle(PlainButtonStyle())
            .disabled(isSaving)
            ...
            Button(action: {
                ...
                .background(
                    Capsule()
                        .stroke(DesignTokens.Brand.primary, lineWidth: 1.5)
