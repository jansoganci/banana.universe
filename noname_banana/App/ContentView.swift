...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .accentColor(themeManager.resolvedColorScheme == .dark ? DesignTokens.Brand.teal : DesignTokens.Brand.primary)
    ...
    private func updateTabBarAppearance(for colorScheme: ColorScheme) {
        ...
        if colorScheme == .dark {
            ...
            // Active tab (using teal accent for dark mode)
            let activeColor = UIColor(swiftUIColor: DesignTokens.Brand.teal)
            ...
            // Active tab (using primary brand color for light mode)
            let activeColor = UIColor(swiftUIColor: DesignTokens.Brand.primary)
            appearance.stackedLayoutAppearance.selected.iconColor = activeColor
            appearance.stackedLayoutAppearance.selected.titleTextAttributes = [.foregroundColor: activeColor]
        }
